...
class Dataset_for(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        for vf in vocoded_audio_files:
            ...
            # Augmented vocoded samples as negative data with random augmentation method
        ...
        for i in range(len(additional_spoofs)):
            # random augmentation method, but only first 3 methods
            augmethod_index = random.choice(range(3))
