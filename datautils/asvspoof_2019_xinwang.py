...
class Dataset_for(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        # merge all the data
        batch_data = [np.expand_dims(real_audio, axis=1)] + augmented_audios + vocoded_audios + augmented_voco
        ...
        label = [1] * (len(augmented_audios) + 1) + [0] * len(self.vocoders*(1+len(self.augmentation_methods)))
