...
class Dataset_for(Dataset):
    def __init__(self, args, list_IDs, labels, base_dir, algo=5, vocoders=[], 
        ...
        self.num_additional_spoof = 1 # number of adversarial spoof samples is 1 only
    ...
    def __getitem__(self, idx):
        ...
        label = [1] * (len(augmented_audios) +len(additional_audios) + 1) + [0] * (len(self.vocoders*2) +1) # 1 addtional for adversarial spoof
        # print("label", label)
